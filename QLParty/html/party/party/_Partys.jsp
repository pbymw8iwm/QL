		...
		<div class="weui_cells">
    	  <div class="weui_cell">
	          ...
	          <div class="weui_cell_bd weui_cell_primary">
	            <p><a href='javascript:gotoPage("/party/party/PartyInfo.jsp?partyId=<%=party.getPartyid()%>","#pi");'><strong class="txt-primary"><%=party.getTheme() %></strong></a>
          ...
          <%} %>
          <a class="weui_cell" href='javascript:gotoPage("/party/party/MemberInfo.jsp?partyId=<%=party.getPartyid()%>&partyName=<%=party.getTheme() %>","#pm");'>
              <div class="weui_cell_bd weui_cell_primary">
	            <p>出席者</p>
	          </div>
	          <div class="weui_cell_ft">
